...
MWF.xApplication.Attendance.Main = new Class({
    ...
    openPersonScheduleSetting: function () {
        MWF.xDesktop.requireApp("Attendance", "PersonScheduleExplorer", function () {
			this.clearContent();
			this.explorerContent = new Element("div", {
				"styles": this.css.rightContentNode
			}).inject(this.node);
			this.explorer = new MWF.xApplication.Attendance.PersonScheduleExplorer(this.explorerContent, this, this.restActions, {"isAdmin": this.isAdmin()});
			this.explorer.load();
        }.bind(this));
    },
...
MWF.xApplication.Attendance.Navi = new Class({
    ...
    createNaviMenuNode: function (data) {
        ...
        menuNode.addEvents({
            ...
            "mouseout": function () {
                if (_self.currentMenu != this) this.setStyles(_self.app.css.naviMenuNode);
            },
            "mousedown": function () {
                if (_self.currentMenu != this) this.setStyles(_self.app.css.naviMenuNode_down);
            },
            "mouseup": function () {
                if (_self.currentMenu != this) this.setStyles(_self.app.css.naviMenuNode_over);
            },
